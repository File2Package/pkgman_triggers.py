...
from PySide2.QtWidgets import QAction, QApplication, QBoxLayout, QCheckBox, QDockWidget, QHeaderView, QMainWindow, QStyle, QToolBar, QTreeWidget, QTreeWidgetItem, QWhatsThis, QWidget  # pylint:disable=no-name-in-module

from . import TriggerManager
from .defaults import configPath
from .triggers import Module, TemporaryID, Trigger
